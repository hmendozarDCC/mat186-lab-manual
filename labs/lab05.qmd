...
Often, you will download a dataset from a site like Kaggle or a government portal.[This link to free  data](https://vincentarelbundock.github.io/Rdatasets/articles/data.html)
...
1. Find any public CSV dataset. For example, [this link to free  data](https://vincentarelbundock.github.io/Rdatasets/articles/data.html). Use the *lbw* data set.
