...
# Lab 5 Final Submission Instructions

::: {.callout-important}
## 📝 Final Checklist for Lab 5
Your folder must be organized exactly as follows:
:::
...
2. You have a folder named `Lab05_YourName` (e.g., `Lab05_HenryMendoza`).
3. **Inside** that `Lab05_YourName` folder, you must have these two files:
    - `Lab5_yourname.qmd` (Your Quarto file).
    - `Lab5_yourname.html` (The rendered report).

### Step 2: Create the ZIP Archive
Since Lab 5 contains both your source code and your rendered math, you must package them together:

1. Open your computer's **File Explorer** (Windows) or **Finder** (Mac).
2. Navigate to your `MAT186_Labs/Lab_solutions/` directory.
3. **Right-click** on your `Lab05_YourName` folder.
4. Select **Compress** (Mac) or **Send to > Compressed (zipped) folder** (Windows).
5. You will now see a new file named `Lab05_YourName.zip`.

### Step 3: Submit to Brightspace

1. Log into **Brightspace** and navigate to **Assignments > Lab 5 Submission**.
