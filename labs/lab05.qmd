...
::: {.callout-note}
## Tip for Students
To run the code below, insert a chunk by making click the green **arrow** button in the top-right corner. The chunk result will appear directly into document.
:::
